...
def train(config):
    ...
    ######### Optimizer ###########
    optimizer = optim.Adam(graph_net_model.parameters(), lr=1e-5)
    ...
    for run in range(1, 11):
        ...
        for epoch in range(start_epoch, 101):
            ...
            for i, (img_clean, img_ori) in enumerate(tqdm(train_loader)):
                ...
                loss_val = 0.5 * criterion_char(img_clean, enhanced_image) + 0.5 * (1 - criterion_ssim(img_clean, enhanced_image))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--enhan_images_path', type=str, default="/workspace/abc/dataset/UFO/TRAIN/hr")
    parser.add_argument('--ori_images_path', type=str, default="/workspace/abc/dataset/UFO/TRAIN/lrd")
